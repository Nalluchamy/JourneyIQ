  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center py-20 border border-dashed border-border rounded-3xl bg-card/20">
        <Info className="mx-auto h-12 w-12 text-muted-foreground animate-pulse mb-4" />
        <h1 className="text-3xl font-extrabold text-white sm:text-4xl">About JourneyIQ</h1>
        <p className="mx-auto mt-4 max-w-md text-muted-foreground">
          JourneyIQ analyzes real-time customer behavioral patterns and runs predictive models to
          improve conversions.
        </p>
